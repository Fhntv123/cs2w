...
public:
    ...
    {
#ifdef CS_PARANOID
        CS_ASSERT(Functions::fnCreateBaseTypeCache != nullptr);
#endif

        return ReturnAddressSpoofer::SpoofCall(ReturnAddressSpoofGadgets::m_pClientGadet, Functions::fnCreateBaseTypeCache, this, nClassID);
    }
};