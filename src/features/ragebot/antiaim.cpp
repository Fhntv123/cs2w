...
//#endif
	...
	if (Input::WasKeyPressed(Config::kb(g_Variables.m_Ragebot.m_iLeftAntiaimKeybind).m_iKey))
	{
		Input::arrKeyBooleans[Config::kb(g_Variables.m_Ragebot.m_iRightAntiaimKeybind).m_iKey] = false;
	}
	else if (Input::WasKeyPressed(Config::kb(g_Variables.m_Ragebot.m_iRightAntiaimKeybind).m_iKey))
	{
		Input::arrKeyBooleans[Config::kb(g_Variables.m_Ragebot.m_iLeftAntiaimKeybind).m_iKey] = false;
	}
	...
	if (Input::HandleInput(Config::kb(g_Variables.m_Ragebot.m_iLeftAntiaimKeybind)))
	{
		if (!Input::m_bManualLeftActive) {
			Input::m_bManualLeftActive = true;
			Input::m_bManualRightActive = false;
		}
	...
	{
		if (!Input::m_bManualRightActive) {
			Input::m_bManualLeftActive = false;
			Input::m_bManualRightActive = true;
		}
