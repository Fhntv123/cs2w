...
namespace H
{
	bool Setup()
	{
		...
		//if (!hkBatchList.Create(reinterpret_cast<void*>(M::FindPattern(L"scenesystem.dll", "4C 8B DC 53 48 81 EC ? ? ? ? 83 79")), &D::hkBatchList))
		//{
		//	printf("[---] Failed to create hkBatchList hook!\n");
