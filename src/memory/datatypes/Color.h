...
public:
	...
	Color operator+(const Color& colOther) const
	{
		return Color(
			std::min(255, static_cast<int>(this->arrColor.at(0)) + static_cast<int>(colOther.arrColor.at(0))),
			std::min(255, static_cast<int>(this->arrColor.at(1)) + static_cast<int>(colOther.arrColor.at(1))),
			std::min(255, static_cast<int>(this->arrColor.at(2)) + static_cast<int>(colOther.arrColor.at(2))),
			std::min(255, static_cast<int>(this->arrColor.at(3)) + static_cast<int>(colOther.arrColor.at(3)))
		);
	}

	Color& operator+=(const Color& colOther)
	{
		this->arrColor.at(0) = static_cast<std::uint8_t>(std::min(255, static_cast<int>(this->arrColor.at(0)) + static_cast<int>(colOther.arrColor.at(0))));
		this->arrColor.at(1) = static_cast<std::uint8_t>(std::min(255, static_cast<int>(this->arrColor.at(1)) + static_cast<int>(colOther.arrColor.at(1))));
		this->arrColor.at(2) = static_cast<std::uint8_t>(std::min(255, static_cast<int>(this->arrColor.at(2)) + static_cast<int>(colOther.arrColor.at(2))));
		this->arrColor.at(3) = static_cast<std::uint8_t>(std::min(255, static_cast<int>(this->arrColor.at(3)) + static_cast<int>(colOther.arrColor.at(3))));
		return *this;
	}
