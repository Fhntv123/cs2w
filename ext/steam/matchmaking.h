...
struct MatchMakingKeyValuePair_t
{
	...
	{
		CRT::StringCopyN(m_szKey, pchKey, sizeof(m_szKey)); // this is a public header, use basic c library string funcs only!
		m_szKey[sizeof(m_szKey) - 1] = '\0';
		CRT::StringCopyN(m_szValue, pchValue, sizeof(m_szValue));
...
#else
	CRT::StringPrintN(s[nBuf], sizeof(s[nBuf]), "%u.%u.%u.%u:%i", (int)(ipByte[3]), (int)(ipByte[2]), (int)(ipByte[1]), (int)(ipByte[0]), usPort);
#endif
...
{
	CRT::StringCopyN(m_szServerName, pName, sizeof(m_szServerName));
