...
#define STEAMMATCHMAKING_INTERFACE_VERSION X("SteamMatchMaking009")
...
#define STEAMMATCHMAKINGSERVERS_INTERFACE_VERSION X("SteamMatchMakingServers002")
...
#define STEAMGAMESEARCH_INTERFACE_VERSION X("SteamMatchGameSearch001")
...
#define STEAMPARTIES_INTERFACE_VERSION X("SteamParties002")
