...
{
protected:
	template< typename Function > Function TopChinaVFuncNumber1CowboyHotdogCrutchesDEVDeluxe2020SexDotComHaramLobster(PVOID Base, DWORD Index)
	{
...
#define STEAMFRIENDS_INTERFACE_VERSION X("SteamFriends017")
