...
public:
	...
	virtual HAuthTicket GetAuthSessionTicket( void *pTicket, int cbMaxTicket, uint32 *pcbTicket, const void *pSteamNetworkingIdentity ) = 0;
...
#define STEAMUSER_INTERFACE_VERSION X("SteamUser023")
