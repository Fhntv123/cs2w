...
public:
	...
	virtual EGCResults SendMessageGC( uint32 unMsgType, const void *pubData, uint32 cubData ) = 0;
...
#define STEAMGAMECOORDINATOR_INTERFACE_VERSION X("SteamGameCoordinator001")
