...
namespace c {
	...
	inline ImVec4 accent = ImColor(112, 123, 251, 255);

	namespace bg
	{

		inline ImVec4 background = ImColor(15, 15, 15, 255);
		inline ImVec2 size = ImVec2(920, 610);
	...
	namespace child
	{
		...
		inline ImVec4 background = ImColor(17, 17, 19, 175);
	...
	namespace text
	{
		...
		inline ImVec4 text_hov = ImColor(90, 90, 90, 255);
		inline ImVec4 text = ImColor(75, 75, 75, 255);
